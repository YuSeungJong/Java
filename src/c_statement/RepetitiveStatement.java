...
public class RepetitiveStatement {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * for문 - for(조기화; 조건식; 증감식){} - 포함하고 있는 문장들을 정해진 횟수만큼 반복하게 해주는 문장
		 */

		// for(int i = 1; i <= 10; i++){
		// //초기화 : 조건식과 증감식에 사용할 변수 초기화
		// //조건식 : 연산결과가 true이면 블러안의 내용을 수행한다.
		// //증감식 : 변수를 증가/감소시켜 반복문을 제어한다.
		// System.out.println(i + "번째 반복");
		// //초기화한 변수를 블럭안에서 사용할 수 있다.
		// }
		//
		// //규칙이 있는 문장들을 효율적으로 작성하기 위해 반목문을 사용한다.
		//
		...
		// 구구단 전체를 가로로 출력해주세요
		/*
		 * 2 * 1 = 2 3 * 1 = 3 4 * 1 = 4 2 * 2 = 4 3 * 2 = 6 4 * 2 = 8 ....
		 */
		// for(int i = 1; i <= 9;i++){
		// for(int j = 2; j <=9; j++){
		...
		//
		/*
		 * while문 - while(조건식){} - 포함하고 있는 문장들을 조건식이 만족하는 동안 반복하는 문장 - 반복횟수가
		 * 정확하지 않은 경우에 주로 사용한다.
		 */
